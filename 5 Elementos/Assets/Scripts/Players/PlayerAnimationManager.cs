...
public class PlayerAnimationManager : MonoBehaviour
{
    ...
    void Awake()
    {
        ...
        ComboGround1 = new CustomAnimation("ComboGround1", anim, 1.1f);
        ComboGround2 = new CustomAnimation("ComboGround2", anim, 1.1f);
        ComboGround3 = new CustomAnimation("ComboGround3", anim, 1.2f);
